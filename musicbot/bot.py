...
#######################################################################################################################
    ...
    def _gen_embed(self):
        ...
        e = discord.Embed()
        e.colour = 7506394
        e.set_footer(text='C0ntr0l is an Illu55ion', icon_url='https://st2.depositphotos.com/1340907/8543/v/450/depositphotos_85432894-stock-illustration-pixel-art-8-bit-skull.jpg')
        return e
